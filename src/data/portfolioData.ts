...
export const experiences: Experience[] = [
  {
    ...
    company: "Bounti.ai",
    companyDescription:
      "Real Estate AI SaaS Platform — B.Claw AI OS, GenNodes, LeadTalk, Narrativ, Wired to Win",
    period: "Sep 2024 – Present",
    location: "USA · Remote from Pakistan",
    current: true,
    highlights: [
      "Architected GenNodes UI v2 — a node-based visual workflow builder (React Flow + Ant Design) enabling real estate agents to build AI automations without code; engineered dynamic component rendering and a custom React JSON Schema Form system",
      "Owned full-stack delivery of LeadTalk — ICP workflow engine, search results, and subscription management — while mentoring the frontend team through end-to-end delivery",
      "Built Narrativ v1 & v2 — AI-powered website builder with inline editing, GenNodes API integration, Rust backend, Docker builds, and Playwright E2E testing",
      "Shipped AI tools using Gemini, Claude, and ChatGPT tightly integrated into live SaaS workflows — reducing manual effort for agents, sales, and marketing teams",
      "Developed Wired to Win — AI-based personality assessment and report generation platform for individuals and teams",
      "Integrated 250+ third-party services (WhatsApp, Google Drive, Follow Up Boss, Canva, MLS data providers) into the Bounti platform",
      "Contributed to B.Claw — the AI Operating System for Real Estate — covering calendar management, lead pipeline automation, marketing asset generation, and SOP creation",
    ],
    stack: ["React", "Rust", "React Flow", "Node.js", "LLMs", "Docker", "Playwright", "PostgreSQL", "GCP"],
  },
  {
    id: "freelance",
  ...
  {
    id: "gridizen",
    role: "Dev Manager & Tech Lead",
    company: "Gridizen",
    companyDescription:
      "PropTech SaaS platform for residential property management across UK & UAE markets",
    ...
    stack: ["Angular", "Node.js", "AWS Aurora", "MySQL", "Jenkins", "Stripe", "Metabase"],
  },
  {
    id: "ideatolife-lead",
...
export const projects: Project[] = [
  {
    id: "bclaw",
    name: "B.Claw — AI OS for Real Estate",
    category: "AI & Agentic",
    description:
      "The AI Operating System for Real Estate — calendar management, lead pipeline automation, marketing asset generation, SOP creation, and 250+ integrations.",
  ...
  },
  {
    ...
    category: "AI & Agentic",
    description:
      "Node-based visual workflow automation UI for AI pipelines with dynamic JSON schema rendering and a custom form system — no-code AI automation for real estate agents.",
  ...
  },
  {
    ...
    category: "AI & Agentic",
    description:
      "ICP-driven lead search engine with subscription management and deep GenNodes workflow integration.",
    highlights: ["ICP workflow engine", "Subscription management", "GenNodes API integration"],
    stack: ["React", "TypeScript", "Node.js", "GenNodes API"],
    featured: true,
  },
  {
    id: "narrativ",
    ...
    category: "AI & Agentic",
    description:
      "AI website builder with inline HTML/image editing, GenNodes API integration, a Rust backend, Docker builds, and Playwright E2E testing.",
